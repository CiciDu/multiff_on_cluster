...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Train or evaluate LSTM agent on Multifirefly env")
    # ------------------------------
    ...
    # ------------------------------
    parser.add_argument("--overall-folder", type=str, default='RL_models/LSTM_stored_models/all_agents/oct_18_3/',
